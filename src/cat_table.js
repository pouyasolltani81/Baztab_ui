    ...
    function renderCategoryCell(category) {
        ...
        return `<div class="p-6 w-fit border-2">
            ...
            <div class="flex gap-2 justify-center">
                ...
                <button class="px-3 py-1 bg-green-500 text-white rounded-md text-sm p-4 mt-4 " onclick="change_category_info('${category._id}', '${category.parent_id}', '${category.name.replace(/'/g, '\\\u0027')}', '${category.name_fa}')">تغییر مشخصات</button>
            </div>
        </div>`;
    }
